...
public class JhonJumpRegulation : MonoBehaviour
{
    ...
    public void Detector_Plataforma()
    {
            ...
            if (!Saltando)
            {
                ...
                switch (Fase2)
                {
                    case 0:
                        Gravedad = 0;
                        Fase2 = 1;
                        //ani.Play("Base Layer.Sky", 0, 0);//Los 0 son para reiniciar la ultima animacion.
                        break;
                    case 1:
                        if (Gravedad > -10)
                        {
        ...
        {
            //ani.SetFloat("gravedad", 1); //Animacion salto.
        }
        if (transform.position.y < YPos)
        {
            //ani.SetFloat("gravedad", 0);//Animacion caer despues de salto.
